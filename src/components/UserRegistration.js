...
const UserRegistration = ({ apiBaseUrl, onUserRegistered, onBack }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${apiBaseUrl}/api/users/${endpoint}`, {
        method: "POST",
        headers: {
      ...
      onUserRegistered(data.user, data.token)
    } catch (error) {
